---
name: webnovel-query
description: Use when querying project information about characters, power systems, factions, items, or foreshadowing in a web novel project.
version: 5.5.4
metadata:
  openclaw:
    requires:
