---
name: webnovel-plan
description: Use when creating volume or chapter outlines for a web novel project. Builds structured writing-ready plans from the total outline and creative constraints.
version: 5.5.4
metadata:
  openclaw:
    requires:
